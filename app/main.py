...
def manual_predict(request: Request, Geography: str = Form(...), Gender: str = Form(...), Age: int = Form(...),
                   Balance: float = Form(...), NumOfProducts: int = Form(...), HasCrCard: int = Form(...), IsActiveMember: int = Form(...)):
    # Create a CustomData object from the form input
    custom_data = CustomData(Geography, Gender, Age, Balance, NumOfProducts, HasCrCard, IsActiveMember)
